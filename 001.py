...
# initialize video source, default 0 (webcam)  / 비디오 소스 초기화,
video_path = 'C:/Users/user/Desktop/2020 학교/2학기 산캡2/011/01.mp4'
...
while cap.isOpened():
  ...
  # inference, find faces 추론
  detections = net.forward()

  # postprocessing , 전처리 과정
...
im = Image.open('C:/Users/user/Desktop/2020 학교/2학기 산캡2/011/01.jpg')
cropImage = im.crop((x1, y1, x2, y2))
cropImage.save('C:/Users/user/Desktop/2020 학교/2학기 산캡2/011/01 - crop.jpg')
